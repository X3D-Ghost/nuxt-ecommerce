    ...
    <div class="row px-xl-5">
      ...
      <div class="col-lg-3 col-md-4">
        ...
        <h5 class="section-title position-relative text-uppercase mb-3">
          <span class="bg-secondary pe-3">Filter by price</span>
        </h5>
          ...
          <form>
            ...
            >
              ...
              <label class="custom-control-label" for="price-all"
                >All Price</label
              >
              <span class="badge border fw-normal">1000</span>
            </div>
            <div
              class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3"
            >
              ...
              <label class="custom-control-label" for="price-1"
                >$0 - $100</label
              >
              <span class="badge border fw-normal">150</span>
            </div>
            <div
              class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3"
            >
              ...
              <label class="custom-control-label" for="price-2"
                >$100 - $200</label
              >
              <span class="badge border fw-normal">295</span>
            </div>
            <div
              class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3"
            >
              ...
              <label class="custom-control-label" for="price-3"
                >$200 - $300</label
              >
              <span class="badge border fw-normal">246</span>
            </div>
            <div
              class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3"
            >
              ...
              <label class="custom-control-label" for="price-4"
                >$300 - $400</label
              >
              <span class="badge border fw-normal">145</span>
            </div>
            <div
            ...
            >
              ...
              <label class="custom-control-label" for="price-5"
                >$400 - $500</label
              >
              <span class="badge border fw-normal">168</span>
            </div>
          </form>
        </div>
        <!-- Price End -->
        ...
        <!-- Color Start -->
        <h5 class="section-title position-relative text-uppercase mb-3">
          <span class="bg-secondary pe-3">Filter by color</span>
        </h5>
        <div class="bg-light p-4 mb-30">
          <form>
            <div
        ...
        <!-- Size Start -->
        <h5 class="section-title position-relative text-uppercase mb-3">
          <span class="bg-secondary pe-3">Filter by size</span>
        </h5>
        <div class="bg-light p-4 mb-30">
          <form>
            <div
            ...
            <div class="product-item bg-light mb-4">
              ...
              <div class="text-center py-4">
                ...
                >
                  ...
                  <small class="fa fa-star text-primary me-1"></small>
                  <small class="fa fa-star-half-alt text-primary me-1"></small>
                  <small class="far fa-star text-primary me-1"></small>
                  <small>(99)</small>
                </div>
              </div>
            </div>
